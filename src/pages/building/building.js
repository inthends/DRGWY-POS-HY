...
import {
    View, StyleSheet, FlatList, NativeModules, Alert,
    //Linking
...
class BuildingPage extends BasePage {
    ...
    static navigationOptions = ({ navigation }) => {
        return {
            ...
            // //add 
            // headerLeft: (
            //     <TouchableOpacity onPress={() => navigation.logout()}>
            ...
            <View style={styles.all}>
                <CommonView style={{ flex: 1 }}>
                    <View style={styles.content}>
                        ...
                        <FlatList
                            data={dataInfo.data}
                            renderItem={({ item }) => <BuildingCell nextRouteName='feeBuildings' {...this.props} item={item} />}
                            style={styles.list}
