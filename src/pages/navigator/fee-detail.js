  ...
  changeItem = (item) => {
    ...
    if (type === '已收') {
      ...
      if (items.length != 0) {
        ...
        this.setState({ price: 0.0, mlAmount: 0.0 });
      }
    }
  };
      ...
      >
        <Flex style={styles.check}>
          ...
          >
            ...
            >
              <Text style={{ fontSize: 16, width: '80%', color: 'green' }}>
                {item.allName}
              </Text>
              {type !== '已收' && (
                <ActionPopover
            ...
            >
              ...
              {type === '已收' ? (
                <Text style={{ fontSize: 16 }}>{item.billCode}</Text>
              ) : item.rmid ? (
                <Flex>
    ...
    return (
      <CommonView style={{ flex: 1 }}>
        <ScrollView onScrollBeginDrag={() => console.log('onScrollBeginDrag')}>
          <Text style={{ paddingLeft: 10, paddingTop: 10, fontSize: 18 }}>
            {room.allName} {room.tenantName}
          </Text>
        ...
        {type === '已收' || dataInfo.data.length === 0 ? null : (
          <Flex style={{ marginBottom: 30 }} direction={'column'}>
            <Flex justify={'between'}>
              ...
              >
                <Text style={{ paddingTop: 3, paddingLeft: 3 }}>抹零</Text>
              </Checkbox>
            ...
            <Flex style={{ minHeight: 40 }}>
              ...
              >
                <Flex
                  justify={'center'}
                  style={[styles.ii, { backgroundColor: Macro.color_f39d39 }]}
                >
              ...
              <TouchableWithoutFeedback onPress={() => this.click('现金')}>
                <Flex
                  justify={'center'}
                  style={[styles.ii, { backgroundColor: 'green' }]}
                >
        ...
        {this.state.chaifeiAlert && (
          <TouchableWithoutFeedback
            onPress={() => this.setState({ chaifeiAlert: false })}
          >
